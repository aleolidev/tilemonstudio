...
class Tileset():
    ...
    def combine_tilepals(self,tilepals, n_colors):
        ...
        # list_of_tiles = self.listOfTiles.copy()
        # ref_tilepals = tilepals.copy()

        # opt2 = []

        # v = list(map(lambda x: self.get_num_tiles_per_palette(x,list_of_tiles.values()),ref_tilepals))
        # wt = list(map(len,ref_tilepals))
        ...
        #         print("vi:", vi)
        #         data_old = data.copy()
        #         pal = ref_tilepals.pop(data_old.index((vi,wti)))
        #         cs.update(pal)
        #         # print("len1:", len(list_of_tiles))
        #         for tile in self.check_tiles_per_palette(cs,list_of_tiles.values()):
        #             list_of_tiles = {key:val for key, val in list_of_tiles.items() if val.tileId != tile}
        #         # print("len2:", len(list_of_tiles))
        ...
        #     # cs = set()
        #     # data_old = data.copy()
        #     # for vi, wti in zip(vs,wts):
        #     #     pal = ref_tilepals.pop(data_old.index((vi,wti)))
        #     #     for tile in self.check_tiles_per_palette(pal,list_of_tiles.values()):
        #     #         list_of_tiles = {key:val for key, val in list_of_tiles.items() if val.tileId != tile}
        #     #         # pass
        #     #     v = list(map(lambda x: self.get_num_tiles_per_palette(x,list_of_tiles.values()),ref_tilepals))
        #     #     wt = list(map(len,ref_tilepals))
    ...
    def get_num_tiles_per_palette(self,palette,listOfTiles=None):
        return len(self.check_tiles_per_palette(palette,listOfTiles))
